...
from tools.engine import (  # noqa: E402
    PROVIDERS, resolve_config, get_engine_config, set_engine_config,
    call_llm_with_tools,
)
...
def main():
    global PROVIDER, MODEL, HAS_KEY, ENGINE_CONFIG
    ...
    parser.add_argument("--provider", choices=list(PROVIDERS), default=None,
                        help="Tên provider; mặc định lấy UI_PROVIDER / DEFAULT_PROVIDER trong .env")
